<nav class="navbar navbar-expand-lg navbar-dark">
    ...
    <button type="button" data-toggle="collapse" data-target="#navbarSupportedContent"
        ...
        class="navbar-toggler navbar-light ml-auto"><span class="navbar-toggler-icon"></span>
    </button>
        ...
        <ul class="navbar-nav ml-auto text-right">
            <li class="nav-item dropdown">
                <a class="nav-link active dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true"
                    aria-expanded="false" id="navbarDropdown" role="button">SERVICES</a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a href="https://www.temairazu.com/service/about" class="dropdown-item">What is
                        Temairazu</a>
                    <a href="https://www.temairazu.com/service/feasible" class="dropdown-item">What can you do with
                        Temairazu?</a>
                    <a href="https://www.temairazu.com/service/netTwo" class="dropdown-item">.NET2</a>
                    <a href="https://www.temairazu.com/service/yield" class="dropdown-item">Temairazu YIELD</a>
                    <a href="https://www.temairazu.com/service/intro_example" class="dropdown-item">Case Study</a>
                </div>
            </li>

            <li class="nav-item"><a href="#news" class="nav-link active">NEWS</a>
            ...
            <li class="nav-item"><a href="#careers" class="nav-link active">CAREERS</a>
            </li>
